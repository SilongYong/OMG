...
def extract_file_paths_and_ids(data):
    ...
    for frame in frames:
        ...
        if file_path:
            # Extract the ID from the file_path
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default="/home/silong/silong/relightanything3d/GaussianShader/data/GlossySynthetic", help="path to the GlossyBlender dataset")
    ...
    with open("/home/silong/silong/relightanything3d/GaussianShader/data/horse_blender/transforms_test.json", ) as f:
        test_split = json.load(f)
        test_ids = extract_file_paths_and_ids(test_split)
    with open("/home/silong/silong/relightanything3d/GaussianShader/data/horse_blender/transforms_train.json", ) as f:
        train_split = json.load(f)
        train_ids = extract_file_paths_and_ids(train_split)
